...
// Enum para o tipo de checklist
enum CheckListTipo: String, Codable {
    case entrega = "Entrega"
    case devolucao = "Devolução"
}

// Modelo de Checklist para Devolução
struct ChecklistDevolucao: Identifiable, Codable {
    var id: UUID = UUID()
    var tipo: CheckListTipo = .devolucao
    ...
    enum CodingKeys: String, CodingKey {
        case id, tipo, dataRegistro, horaRegistro, funcionario, placa, combustivel, observacoes, assinatura
    }
